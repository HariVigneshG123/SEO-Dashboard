...
public class gscDbConfig {
	...
	public LocalContainerEntityManagerFactoryBean gscEntityManagerFactory(EntityManagerFactoryBuilder builder,
	...
	public PlatformTransactionManager gscTransactionManager(
			@Qualifier("gscEntityManagerFactory") EntityManagerFactory gscEntityManagerFactory) {
		return new JpaTransactionManager(gscEntityManagerFactory);
	}
}
